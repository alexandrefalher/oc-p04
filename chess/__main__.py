...
router: Router = Router([
    ...
    Route(endpoint="/report/tournamentlist", module="chess.controller.report_controller", controller="ReportController", method="get_tournaments"),
    Route(endpoint="/report/tournamentdetails", module="chess.controller.report_controller", controller="ReportController", method="get_tournament"),
    Route(endpoint="/report/tournamentplayersalpha", module="chess.controller.report_controller", controller="ReportController", method="get_tournament_players_by_alphabet"),
    Route(endpoint="/report/tournamentplayersrank", module="chess.controller.report_controller", controller="ReportController", method="get_tournament_players_by_rank"),
    Route(endpoint="/report/tournamentrounds", module="chess.controller.report_controller", controller="ReportController", method="tournament_rounds"),
    Route(endpoint="/report/tournamentmatchs", module="chess.controller.report_controller", controller="ReportController", method="tournament_matchs"),
